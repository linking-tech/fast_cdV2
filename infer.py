...
def plot_error_and_value_distribution(pred, true, save_path_base="plots/"):
    ...
    plt.close()
def plot_trajectory_error_curve(y_pred, y_true, threshold=0.01, num_steps=30000):
    """
...
def main():
    ...
    model_path = "models/fast_sdf_model.pt"
    ...
    plot_trajectory_error_curve(y_pred, y_true,threshold=0.05)
